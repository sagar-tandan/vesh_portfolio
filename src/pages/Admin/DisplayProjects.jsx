...
export default function DisplayProjects() {
  ...
  const [deleteProjectId, setDeleteProjectId] = useState(null); // State to store the ID of the project to delete
  ...
  const deleteProject = async (projectId) => {
    ...
    //   console.log((doc(db, "Projects", projectId)))
      setProject(project.filter(project => project.id !== projectId));
